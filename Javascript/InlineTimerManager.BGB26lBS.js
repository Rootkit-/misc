import {r as n} from "https://rootkit-.github.io/misc/Javascript/index.RH_Wq4ov.js";
var k = {
    exports: {}
}
  , A = {};
...
const F = {
  ...
  , W = ({currentPostId: d, position: l=F.POSITION, session: r, uniqueId: E=`inline-${l}`, activationDelay: o=F.ACTIVATION_DELAY, timerSeconds: u=F.TIMER_SECONDS, clickOfferEnabled: s=!1, onTimerComplete: i}) => {
    const c = r?.stepTime || u;
