...
function Z() {
    ...
    function B(t) {
        ...
        case "rejected":
            throw t.reason;
        default:
            switch (typeof t.status == "string" ? t.then(P, P) : (t.status = "pending",
            t.then(function(e) {
    ...
    function _(t, e, n, r, s) {
        ...
        if (u)
            ...
            _(s, e, n, "", function(X) {
                return X
            })) : s != null && (T(s) && (s = G(s, n + (s.key == null || t && t.key === s.key ? "" : ("" + s.key).replace(j, "$&/") + "/") + u)),
            e.push(s)),
            1;
        u = 0;
        var p = r === "" ? "." : r + ":";
    ...
    o.cloneElement = function(t, e, n) {
        ...
        if (e != null)
            ...
            e)
                !H.call(e, u) || u === "key" || u === "__self" || u === "__source" || u === "ref" && e.ref === void 0 || (r[u] = e[u]);
    ...
    o.createElement = function(t, e, n) {
        var r, s = {}, f = null;
        if (e != null)
            for (r in e.key !== void 0 && (f = "" + e.key),
            e)
                H.call(e, r) && r !== "key" && r !== "__self" && r !== "__source" && (s[r] = e[r]);
        var u = arguments.length - 2;
        if (u === 1)
            s.children = n;
        else if (1 < u) {
    ...
    o.startTransition = function(t) {
        ...
        try {
            var r = t()
              , s = i.S;
            s !== null && s(n, r),
            typeof r == "object" && r !== null && typeof r.then == "function" && r.then(Q, $)
        } catch (f) {
            $(f)
        } finally {
            i.T = e
